...
Após o logout da aplicação é necessário chamar o método _stop_ para parar a emissão dos eventos para o agente.

Caso esteja utilizando o _OlosAgentWS_, chame o método _stop_ da instância:

```js copy
agentWS.stop();
```

Caso esteja utilizando também o _OlosAgentChannelWs_, chame o método _stop_ da instância dele também:
